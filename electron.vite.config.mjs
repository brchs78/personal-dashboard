        ...
        build: {
            rollupOptions: {
                input: {
                    ...
                    "coros-store": resolve("src/main/coros-store.js"),
                    "coros-auth": resolve("src/main/coros-auth.js"),
                    "coros-client": resolve("src/main/coros-client.js"),
                    "coros-ipc": resolve("src/main/coros-ipc.js"),
                    ...
                    "kitchen-store": resolve("src/main/kitchen-store.js"),
                    "kitchen-ai": resolve("src/main/kitchen-ai.js"),
                    "kitchen-ipc": resolve("src/main/kitchen-ipc.js"),
                    "debrief-store": resolve("src/main/debrief-store.js"),
                    "debrief-ipc": resolve("src/main/debrief-ipc.js"),
                    "training-log-store": resolve("src/main/training-log-store.js"),
                    "training-log-ipc": resolve("src/main/training-log-ipc.js"),
                },
            },
        },
    },
